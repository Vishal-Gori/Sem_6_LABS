...
var Employee = /** @class */ (function (_super) {
    ...
    Employee.prototype.humanity = function () {
        return "".concat(this.firstName, " is ").concat(this.race, " and they show Humanity ");
    };
    Employee.prototype.humble = function () {
        return "".concat(this.firstName, " is Humble");
    };
    return Employee;
}(Person));
var emp1 = new Employee("Niyati", "Gaonkar", "Data Analyst");
